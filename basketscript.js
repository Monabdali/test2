$(document).ready(function() {
    ...
    $('.add-to-cart').click(function() {
        ...
        //let productPrice = parseFloat($(this).closest('.product-card').data('price'));
    ...
    function updateCart() {
        ...
        cartItems.forEach(item => {
            ...
            cartItemsHtml += `
                <tr>
                    ...
                    <td>
                        <button class="remove-from-cart" data-product-id="${item.id}"><i class="bi bi-x-circle"></i></button>
                    </td>
                </tr>
            `;
        });
        ...
        $('#cart-total').text('SR' + cartTotal.toFixed(2));
